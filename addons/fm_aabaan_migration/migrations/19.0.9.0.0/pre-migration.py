# -*- coding: utf-8 -*-
"""Retire fm_aabaan_migration: purge its residual DB records FK-safe on the production upgrade.
...
MODULE = "fm_aabaan_migration"
DEFUNCT_MODELS = ("fm.aabaan.migration.wizard",)
